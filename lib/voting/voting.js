(function() {
    ...
    define(deps, function(
        ...
        /**
         * posts a comment explaining that the vote has started (if one isn't already posted)
         * @param pr
         */
        ...
        /**
         * Checks for a "vote started" comment posted by ourself returns the comment if found
         * @param pr
         * @param cb
         * @returns {*}
         */
        ...
        /**
         * Calls cb if the PR has not been committed to since the voting started, otherwise displays an error
         * @param pr
         * @param cb
         */
         ...
         * @param text
         * @returns {boolean} True if positive vote
         */
         ...
         * @param text
         * @returns {boolean} True if negative vote
         */
         ...
         * @param text
         * @returns {boolean} True if monkey
         */
        ...
        Voting.minVotes = config.voting.minVotes;

        Voting.period = period;

        Voting.supermajority = config.voting.requiredSupermajority;

        Voting.guaranteedResult = config.voting.guarantedResult;
