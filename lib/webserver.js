    ...
    module.exports = function (config, events) {
        ...
        app.get('/', function (req, res) {
            ...
            repo.commits(function (err, commits) {
                ...
                var response = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><style>li:nth-child(2n+1){background: #efffef;}li:nth-child(2n){background: #efefff;}body {font-family: "Trebuchet MS", Helvetica, sans-serif;}</style><title>Recent commits</title></head><body>' +
                    '<p><a href="/stdout">Standard Output</a></p><center>' +
                    'Last 10 commits:<br/><ul style="display: inline-block">';
                response += commitLog.join('') + '</ul><iframe src="https://ghbtns.com/github-btn.html?user=botwillacceptanything&repo=botwillacceptanything&type=star&count=true&size=large" frameborder="0" scrolling="0" width="160px" height="30px"></iframe></center></body></html>';
                res.send(response);
            });
        });

        app.get('/stdout', function (req, res) {
            var response = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><style>li:nth-child(2n+1){background: #efffef;}li:nth-child(2n){background: #efefff;}body {font-family: "Trebuchet MS", Helvetica, sans-serif;}</style><title>Standard Output</title></head><body>' +
                '<p><a href="/">Home</a></p>' +
                '<center><h1>Standard Output</h1><ul style="display: inline-block"><li>';
            response += stdoutLog.join('</li><li>') + '</li></ul><iframe src="https://ghbtns.com/github-btn.html?user=botwillacceptanything&repo=botwillacceptanything&type=star&count=true&size=large" frameborder="0" scrolling="0" width="160px" height="30px"></iframe></center></body></html>';
            res.send(response);
        });
