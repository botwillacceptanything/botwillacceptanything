    ...
    module.exports = function (config, events) {
        ...
        app.get('/', function (req, res) {
            ...
            repo.commits(function (err, commits) {
                ...
                var response = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><style>li:nth-child(2n+1){background: #efffef;}li:nth-child(2n){background: #efefff;}body {font-family: "Trebuchet MS", Helvetica, sans-serif;}</style><title>Recent commits</title></head><body><center>' +
        ...
        app.get('/stdout', function (req, res) {
            var response = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><style>li:nth-child(2n+1){background: #efffef;}li:nth-child(2n){background: #efefff;}body {font-family: "Trebuchet MS", Helvetica, sans-serif;}</style><title>Standard Output</title></head><body><center>' +
                '<p><a href="/">Home</a></p>' +
