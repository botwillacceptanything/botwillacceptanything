(function () {
    ...
    define(deps, function (deferred, gh, config, events) {
        module.exports = function (labelNames) {
            ...
            events.on('bot.pull_request.vote_started', function (pr) {
                ...
                deferredLabels.then(function (labels) {
                    ...
                    newStatuses = addStatus(labelNames.votingUnderway, labels);
            ...
            events.on('github.pull_request.closed', function (event) {
                ...
                deferredLabels.then(function (labels) {
                    ...
                    newStatuses = addStatus(labelNames.rejected, labels);
            ...
            events.on('github.pull_request.merged', function (event) {
                ...
                deferredLabels.then(function (labels) {
                    ...
                    newStatuses = addStatus(labelNames.merged, labels);
