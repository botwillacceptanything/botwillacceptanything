    ...
    define(deps, function (deferred, config, events, irc, util, Conversation) {
        module.exports = function () {
            ...
            if(!config.irc) {
                ...
                console.log("IRC is trying to connect to " + config.irc.host + ":" + config.irc.port + " and joining channel " + config.irc.channel + " as " + config.irc.user);
            }
            ...
            client.on('message', function (from, to, message) {
                var msg = message.search(config.irc.user);
                if (msg > -1) {
            ...
            client.on('ctcp-version', function (from, to, message) {
                Client.notice(from, "" + os.type + " " + os.release + "");
            });
